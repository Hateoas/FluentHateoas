...
namespace FluentHateoas.Registration
{
    ...
    {
        public static HateoasExpressionBuilder<TModel> Register<TModel>(this IHateoasContainer container, string relation = null, Expression<Func<TModel, object>> idGetter = null)
        {
