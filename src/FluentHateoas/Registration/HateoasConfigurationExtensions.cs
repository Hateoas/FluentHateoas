...
namespace FluentHateoas.Registration
{
    ...
    public static class HateoasConfigurationExtensions
    {
        ...
        private static void TryExtendHrefStyle(HateoasConfiguration configuration, IDictionary<string, object> varsDictionary)
        {
            object hrefStyle;
        ...
        private static void TryExtendLinkStyle(HateoasConfiguration configuration, IDictionary<string, object> varsDictionary)
        {
            object linkStyle;
        ...
        private static void TryExtendTemplateStyle(HateoasConfiguration configuration, IDictionary<string, object> varsDictionary)
        {
